...
- **[Extism](https://extism.org/):** [Rust, JavaScript, Elixr, Go, Haskell, Java, .NET, OCaml, PHP, Python, Ruby, Zig, C, C++] The framework for building with WebAssembly (wasm). Easily load wasm modules, move data, call functions, and build extensible apps.

- **[Fizzy](https://github.com/wasmx/fizzy):** [C] Fizzy aims to be a fast, deterministic, and pedantic WebAssembly interpreter written in C++.

- **[GraalWasm](https://github.com/oracle/graal/tree/master/wasm):** [Java] GraalWasm is a WebAssembly engine implemented in GraalVM. It can interpret and compile WebAssembly programs in the binary format, or be embedded into other programs.

- **[Wasm3](https://github.com/wasm3/wasm3):** [Python, Rust, C, C++, Go, Zig, Perl, Swift, .NET, Nim, Arduino, PlatformIO, Particle, QuickJS] 🚀 A fast WebAssembly interpreter and the most universal WASM runtime

<details><summary>Older</summary>

<sub>These awesome WebAssembly runtimes haven't seen updates in a while</sub>

- **[cmm_of_wasm](https://github.com/SimonJF/cmm_of_wasm):** A compiler from WebAssembly to native code, via the OCaml backend.

- **[EOS VM](https://github.com/EOSIO/eos-vm):** [C++] A Low-Latency, High Performance and Extensible WebAssembly Backend Library

- **[FuncDef VM](https://github.com/funcdef/fdvm):** Server-side WebAssembly Runtime

- **[Happy New Moon with Report](https://github.com/fishjd/HappyNewMoonWithReport):** [Java] Happy New Moon with Report is an open-source implementation of WebAssembly written entirely in Java. It is typically used to run or test Web Assembly Modules (*.wasm) in Java.

- **[inNative](https://github.com/innative-sdk/innative):** [C] A native non-web embedding of WebAssembly for Windows/Linux

- **[Life](https://github.com/perlin-network/life):** [Go] A secure WebAssembly VM catered for decentralized applications.
